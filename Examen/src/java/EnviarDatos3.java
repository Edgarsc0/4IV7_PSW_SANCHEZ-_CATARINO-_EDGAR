...
public class EnviarDatos3 extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            int bol=Integer.parseInt(request.getParameter("usu"));
...
"            } #er{font-size:35px;}");
            ...
            out.println("<table align='center' id='tb' border='1'>"
                    ...
                    + "</tr>");
            try{
                String q="select nombre,appat,apmat from nombres where usuario="+bol;
                set=con.createStatement();
                ...
                try{
                    String newq="insert into solicitud(dia,mes,anno,hora,asunto,usuario_solicitante) values("+dia+","+mes+","+dateYear+",'"+hora+":"+minutos+"','"+asunto+"',"+bol+")";
